          ...
          child: ListView.builder(
            itemBuilder: ((context, index) => Container(
                  ...
                  builder:(context) =>Padding( 
                      ...
                      child: Column(
                        ...
                        children: [
                         ...
                         button(padding: 150, text: 'حفظ', function:()async{
                                  SharedPreferences shared=await SharedPreferences.getInstance();
                           await CacheHelper.putInt(widget.name[index],
                           int.parse(widget.controller.text),shared).then((value) => 
                           setState(() {
                               Navigator.of(context).pop();
                           })
                           );
                              widget.value[index]= int.parse(widget.controller.text);
              ...
              style: TextStyle(fontSize: 20,fontWeight: FontWeight.w300,color: Colors.white)
               ...
               BoxText(padding:  MediaQuery.of(context).size.width *0.333,
               text: 
               '${ widget.value[index]}',
               paddingHeight: 40),
...
class FormFields extends StatelessWidget {
  ...
  FormFields(
      { required this.label,required this.width, required this.icon,required this.controll});
  @override
  Widget build(BuildContext context) {
    return Container(
      width: width,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        button(
          padding: (MediaQuery.of(context).size.width - 120) / 2,
          text: textButon,
          function:function
        ),
      ],
