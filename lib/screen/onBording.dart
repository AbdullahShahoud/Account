...
class _OnBordingState extends State<OnBording> {
    ...
    List Item=[
      ...
      text: 'تطبيق موجه لمساعدة نجاري الالمنيوم على القيام بحساب التكاليف واطوال القطع للتفصيل من عمل المهندس عبدالله محمد شحود',
      textTitle: 'تطبيق حساباتي',),
      IetmBoarding(image:'assets/images/undraw_Calculator_re_alsc.png' ,
      text: 'يقدم ميزة حساب تكاليف العمل للزبون بدقة عالية ووضوح الارقام والتفاصيل',
      textTitle: 'حساب التكليف',),
      IetmBoarding(image:'assets/images/undraw_search_app_oso2.png' ,
      text: 'يحوي على صفحة خاصة لادخال وتخزين اسعار الاكسسوارات بشكل دائم مع إتاحة إمكانية تعديها',
      textTitle: 'حساب الاسعار',)
    ];
    void submit()async{
